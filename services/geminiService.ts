...
export const startChat = (appointmentHistory: Appointment[] = [], labTestHistory: LabTestBooking[] = [], language: 'en' | 'hi' | 'bho' = 'en'): Chat | null => {
    const API_KEY = process.env.API_KEY;
...
You are trilingual and MUST respond in the language the user is using (English, Hindi, or Bhojpuri).
...
**General Rules**:
- **CRITICAL**: The structured commands above (like \`SEARCH_DOCTORS\`) MUST ALWAYS be in English, even if the conversation is in Hindi or Bhojpuri. Do not add any conversational text before or after the command.
