...
const ReminderToast: React.FC<ReminderToastProps> = ({ appointment, onDismiss }) => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-2xl p-4 w-full max-w-sm border-l-4 border-teal-500 animate-slide-in-right" role="alert" aria-live="assertive">
            <div className="flex items-start">
                ...
                <div className="ml-4 flex-shrink-0 flex">
                    <button onClick={() => onDismiss(appointment.id)} className="inline-flex text-gray-400 hover:text-gray-500">
