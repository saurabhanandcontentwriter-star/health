...
export const MicOffIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M12 1a3 3 0 0 0-3 3v7.34"></path>
...
export const HourglassIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 2v6l6 6-6 6v6h18v-6l-6-6 6-6V2H3z"/>
    </svg>
);
...
export const BotIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className={className}>
        {/* The chat bubble, filled with the current text color (e.g., white on a colored button) */}
        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" fill="currentColor"/>
        
        {/* The pulse line, with a hardcoded teal color to contrast against the white fill */}
        <polyline 
            points="7 12 9 12 11 9 13 15 15 12 17 12" 
            stroke="#0d9488"  /* This is Tailwind's teal-600 */
            strokeWidth="2" 
            strokeLinecap="round" 
