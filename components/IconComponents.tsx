...
export const StethoscopeIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M4.8 2.3A.3.3 0 1 0 5.4 2l-2.3 4.1c-.3.4-.3.9 0 1.3l.3.4a.9.9 0 0 0 1.3 0l4.1-2.3a.3.3 0 1 0-.6-.4L4 8.8l2-3.5 3.5 2 .8.4a.9.9 0 0 0 1.3 0l.3-.4c.4-.3.9-.3 1.3 0l4.1 2.3a.3.3 0 1 0 .5-.6L13 5.4a.9.9 0 0 0-1.3 0L11.2 6l-2-3.5 3.5-2 .4.8a.9.9 0 0 0 1.3 0l.3-.4c.4-.3.9-.3 1.3 0l2.3 4.1a.3.3 0 1 0 .6-.4L14.6 2a.9.9 0 0 0-1.3 0L9.2 6.1 5.4 2.3C5.2 2.1 5 2.1 4.8 2.3Z" />
    <path d="M12 10a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h0a2 2 0 0 0 2-2v-5a2 2 0 0 0-2-2Z" />
    <path d="M12 19v2" />
  </svg>
);
...
export const VideoOffIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M16 16v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2l10 6Z"></path>
...
export const HourglassIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M5 22h14"/>
    <path d="M5 2h14"/>
    <path d="M17 22v-4a5 5 0 0 0-1.52-3.54L8.52 7.54A5 5 0 0 0 7 4V2"/>
    <path d="M7 22v-4a5 5 0 0 1 1.52-3.54L15.48 7.54A5 5 0 0 1 17 4V2"/>
  </svg>
);
...
export const PhoneOffIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81 .7 2 2 0 0 1 1.72 2.06v1.83a2 2 0 0 1-2.28 2.28 19.79 19.79 0 0 1-8.63-3.07 19.42 19.42 0 0 1-3.33-2.67m-2.67-3.34a19.79 19.79 0 0 1-3.07-8.63A2 2 0 0 1 4.11 2h1.83a2 2 0 0 1 2.06 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91"/>
...
export const BotIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M2 12h2"/>
    <path d="M20 12h2"/>
    <path d="M12 12v-2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
  </svg>
);
